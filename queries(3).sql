...
select Departamento.n_dep, Departamento.nome, Departamento.data_criacao, Projeto.tipo, Projeto.n_dep, Projeto.descr, Projeto.cod_proj from Projeto
join Departamento
on Departamento.n_dep =  Projeto.n_dep;

#exibir o nome do Empregado e o salario do Empregado

select Empregado.nome, Categoria.salario from Empregado inner join Categoria
on Empregado.nome_categoria = Categoria.nome_categoria;

#exibir o nome dos empregados que trabalham num projeto de tipo Suporte

select e.nome,  P.tipo from empregado e 
  join Proj_Emp Pe on e.cod_emp = Pe.cod_emp
  join projeto P ON P.cod_proj = Pe.cod_proj
  where p.tipo = "Suporte";

#exibir o nome dos empregados que trabalham num projeto de tipo LibreOffice

select e.nome,  P.tipo from empregado e 
  join Proj_Emp Pe on e.cod_emp = Pe.cod_emp
  join projeto P ON P.cod_proj = Pe.cod_proj
  where p.tipo = "LibreOffice";